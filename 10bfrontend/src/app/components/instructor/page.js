          ...
          <>
            <div className="bg-gray-800 rounded-lg p-4 mb-6 animate-fade-in transition-all duration-500">
              ...
              <div className="grid grid-cols-1 gap-6 mt-6">
                ...
                <button className="bg-blue-400 text-white px-4 py-1 rounded">Assign Problems</button>
                <button className="bg-blue-400 text-white px-4 py-1 rounded">Generate Passcode</button>
                <button className="bg-red-400 text-white px-4 py-1 rounded">Remove</button>
              </div>
            </div>
            <div>
