                         ...
                         {problemsList.slice(0,5).map((problem,index) => (
                            ...
                            />
                              ...
                              <button
                                ...
                                onClick={() => {
                                  router.push(
                                    `/components/problem?netId=${selectedStudent.netId}&topic=${encodeURIComponent(selectedTopic.name)}&difficulty=${encodeURIComponent(selectedDifficulty)}&problem=${encodeURIComponent(problem.id)}&viewingStudent=${selectedStudent.netId}`
                                  );
                                }}
                              >
                                Show
